...
public class ClassWork02 {
    public static void main(String[] args) {
        ...
        if (actualtittle.contains("facebook")){
            System.out.println("Title Testi PASSSED");
        }else
            System.out.println("Tittle Testi FAİLED "+actualtittle);
        ...
        String walmartTittle="Walmart.com";
        if (actualTittle2.contains(walmartTittle)){
            System.out.println("walmart Tittle Testi PASSED");
        }else
            System.out.println("walmart Tittle Testi FAİLED");
